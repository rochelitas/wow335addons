...
------------
  ...
  -- T4/T5/T6 Sets
	AtlasLoot_TableNames["T456DeathKnightDPS"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["DPS"], "AtlasLootBurningCrusade" };
	AtlasLoot_TableNames["T456DeathKnightTank"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["Tanking"], "AtlasLootBurningCrusade" };
  ...
  -- Tier 11 Sets
	AtlasLoot_TableNames["T11DeathKnightDPS"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["DPS"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11DeathKnightTank"] = { LOCALIZED_CLASS_NAMES_MALE["DEATHKNIGHT"].." - "..AL["Tanking"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11DruidBalance"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..AL["Balance"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11DruidFeral"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..AL["Feral"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11DruidRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["DRUID"].." - "..AL["Restoration"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11Hunter"] = { LOCALIZED_CLASS_NAMES_MALE["HUNTER"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11Mage"] = { LOCALIZED_CLASS_NAMES_MALE["MAGE"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11PaladinHoly"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..AL["Holy"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11PaladinProtection"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..AL["Protection"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11PaladinRetribution"] = { LOCALIZED_CLASS_NAMES_MALE["PALADIN"].." - "..AL["Retribution"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11PriestHoly"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." - "..AL["Holy"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11PriestShadow"] = { LOCALIZED_CLASS_NAMES_MALE["PRIEST"].." - "..AL["Shadow"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11Rogue"] = { LOCALIZED_CLASS_NAMES_MALE["ROGUE"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11ShamanElemental"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..AL["Elemental"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11ShamanEnhancement"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..AL["Enhancement"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11ShamanRestoration"] = { LOCALIZED_CLASS_NAMES_MALE["SHAMAN"].." - "..AL["Restoration"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11Warlock"] = { LOCALIZED_CLASS_NAMES_MALE["WARLOCK"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11WarriorFury"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." - "..AL["Fury"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["T11WarriorProtection"] = { LOCALIZED_CLASS_NAMES_MALE["WARRIOR"].." - "..AL["Protection"], "AtlasLootWotLK" };
------------------------
--- Misc Collections ---
------------------------
...
------------------------
	...
	AtlasLoot_TableNames["SIRUSLEGENDARYMENU"] = { AL["SIRUSLEGENDARY"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["SIRUSMOUNTMENU"] = { AL["SIRUSMOUNT"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["SIRUSPETMENU"] = { AL["SIRUSPET"], "AtlasLootWorldEvents" };

	AtlasLoot_TableNames["SIRUSCHESTMENU"] = { AL["SIRUSCHEST"], "AtlasLootWorldEvents" };

	AtlasLoot_TableNames["SIRUSCHEST2MENU"] = { AL["SIRUSCHEST2"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["7Menu+"] = { AL["7+ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["6Menu+"] = { AL["6+ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["6Menu++"] = { AL["6++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["5Menu+"] = { AL["5+ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["5Menu++"] = { AL["5++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["5Menu+++"] = { AL["5+++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["4Menu+"] = { AL["4+ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["4Menu++"] = { AL["4++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["4Menu+++"] = { AL["4+++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["4Menu++++"] = { AL["4++++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["3Menu+"] = { AL["3+ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["3Menu++"] = { AL["3++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["3Menu+++"] = { AL["3+++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["3Menu++++"] = { AL["3++++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["3Menu+++++"] = { AL["3+++++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["2Menu+"] = { AL["2+ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["2Menu++"] = { AL["2++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["2Menu+++"] = { AL["2+++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["2Menu++++"] = { AL["2++++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["2Menu+++++"] = { AL["2+++++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["2Menu++++++"] = { AL["2++++++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["1Menu+"] = { AL["1+ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["1Menu++"] = { AL["1++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["1Menu+++"] = { AL["1+++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["1Menu++++"] = { AL["1++++ kata"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["1Menu+++++"] = { AL["1+++++ kata"], "AtlasLootWorldEvents" };
	...
	AtlasLoot_TableNames["Boss7"] = { AL["Boss7"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["Boss6"] = { AL["Boss6"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["Boss5"] = { AL["Boss5"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["Boss4"] = { AL["Boss4"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["Boss3"] = { AL["Boss3"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["Boss2"] = { AL["Boss2"], "AtlasLootWorldEvents" };
	AtlasLoot_TableNames["Boss1"] = { AL["Boss1"], "AtlasLootWorldEvents" };

	AtlasLoot_TableNames["LordKrimor"] = { AL["LordKrimor"], "AtlasLootWorldEvents" };
...
-------------
  ...
  -- Menus, the entry does nothing, but makes the generalised loot table code less complex
	...
	AtlasLoot_TableNames["PVPOLDSET"] = { AL["PvP Old"], "Menu" };
