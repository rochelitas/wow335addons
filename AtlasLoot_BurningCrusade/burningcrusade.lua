...
--- World Bosses
	...
	AtlasLoot_Data["AuchCryptsShirrak"] = {
		...
		{ 17, 40753, "", "=q4=Emblem of Heroism", "=ds=#e15#", "", "100%"};
		...
		{ 22, 27866, "", "=q4=Scintillating Headdress of Second Sight", "=ds=#s1#, #a1#", "", "15.00%"};
		{ 23, 27493, "", "=q4=Gloves of the Deadwatcher", "=ds=#s9#, #a1#", "", "10.87%"};
		{ 24, 27865, "", "=q4=Bracers of Shirrak", "=ds=#s8#, #a3#", "", "21.74%"};
		{ 25, 27845, "", "=q4=Magma Plume Boots", "=ds=#s12#, #a3#", "", "23.91%"};
		{ 26, 27847, "", "=q4=Fanblade Pauldrons", "=ds=#s3#, #a4#", "", "6.52%"};
		{ 27, 27846, "", "=q4=Claw of the Watcher", "=ds=#h3#, #w13#", "", "6.52%"};
		Next = "AuchCryptsExarch";
	};

	AtlasLoot_Data["AuchCryptsExarch"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 2, 40753, "", "=q4=Emblem of Valor", "=ds=#e15#", "", "100%"};
		...
		{ 7, 27867, "", "=q4=Boots of the Unjust", "=ds=#s12#, #a2#", "", "3.33%"};
		{ 8, 27871, "", "=q4=Maladaar's Blessed Chaplet", "=ds=#s2#", "", "18.33%"};
		{ 9, 27869, "", "=q4=Soulpriest's Ring of Resolve", "=ds=#s13#", "", "18.33%"};
		{ 10, 27523, "", "=q4=Exarch's Diamond Band", "=ds=#s13#", "", "13.33%"};
		{ 11, 27872, "", "=q4=The Harvester of Souls", "=ds=#h1#, #w1#", "", "11.67%"};
		{ 12, 27870, "", "=q4=Doomplate Legguards", "=ds=#s11#, #a4# (D3)", "", "3.33%"};
		{ 14, 90900, "", "=q3=Imperial Moth", "=ds=#e13#", "", ""};
		...
		{ 25, 27411, "", "=q3=Slippers of Serenity", "=ds=#s12#, #a1#", "", "8.14%"};
		{ 26, 27415, "", "=q3=Darkguard Face Mask", "=ds=#s1#, #a2#", "", "11.44%"};
		{ 27, 27414, "", "=q3=Mok'Nathal Beast-Mask", "=ds=#s1#, #a3#", "", "11.27%"};
		{ 28, 27413, "", "=q3=Ring of the Exarchs", "=ds=#s13#", "", "10.42%"};
		{ 29, 27416, "", "=q3=Fetish of the Fallen", "=ds=#s14#", "", "12.81%"};
		{ 30, 27412, "", "=q3=Ironstaff of Regeneration", "=ds=#w9#", "", "11.95%"};
		Prev = "AuchCryptsShirrak";
		Next = "AuchCryptsAvatar";
	};

	AtlasLoot_Data["AuchCryptsAvatar"] = {
		{ 1, 27878, "", "=q4=Auchenai Death Shroud", "=ds=#s4#", "", "4.41%"};
		{ 2, 28268, "", "=q4=Natural Mender's Wraps", "=ds=#s9#, #a2#", "", "3.94%"};
		{ 3, 27876, "", "=q4=Will of the Fallen Exarch", "=ds=#h3#, #w6#", "", "5.10%"};
		{ 4, 27937, "", "=q4=Sky Breaker", "=ds=#h3#, #w6#", "", "3.48%"};
		{ 5, 27877, "", "=q4=Draenic Wildstaff", "=ds=#w9#", "", "4.87%"};
		{ 7, 27797, "", "=q4=Wastewalker Shoulderpads", "=ds=#s3#, #a2# (D3)", "", "3.94%"};
	...
	AtlasLoot_Data["AuchManaPandemonius"] = {
		...
		{ 22, 27816, "", "=q4=Mindrage Pauldrons", "=ds=#s3#, #a1#", "", "13.95%"};
		{ 23, 27818, "", "=q4=Starry Robes of the Crescent", "=ds=#s5#, #a2#", "", "11.63%"};
		{ 24, 27813, "", "=q4=Boots of the Colossus", "=ds=#s12#, #a4#", "", "13.95%"};
		{ 25, 27815, "", "=q4=Totem of the Astral Winds", "=ds=#s16#, #w15#", "", "2.33%"};
		{ 26, 27814, "", "=q4=Twinblade of Mastery", "=ds=#h1#, #w4#", "", "6.98%"};
		{ 27, 27817, "", "=q4=Starbolt Longbow", "=ds=#w2#", "", "9.30%"};
	...
	AtlasLoot_Data["AuchManaTavarok"] = {
		...
		{ 19, 30585, "", "=q4=Glistening Fire Opal", "=ds=#e7#", "", "6.06%"};
		{ 20, 30583, "", "=q4=Timeless Chrysoprase", "=ds=#e7#", "", "9.09%"};
		{ 22, 27824, "", "=q4=Robe of the Great Dark Beyond", "=ds=#s5#, #a1#", "", "9.09%"};
		{ 23, 27821, "", "=q4=Extravagant Boots of Malice", "=ds=#s12#, #a1#", "", "9.09%"};
		{ 24, 27825, "", "=q4=Predatory Gloves", "=ds=#s9#, #a2#", "", "15.15%"};
		{ 25, 27826, "", "=q4=Mantle of the Sea Wolf", "=ds=#s3#, #a3#", "", "3.03%"};
		{ 26, 27823, "", "=q4=Shard Encrusted Breastplate", "=ds=#s5#, #a3#", "", "15.15%"};
		{ 27, 27822, "", "=q4=Crystal Band of Valor", "=ds=#s13#", "", "15.15%"};
	...
	AtlasLoot_Data["AuchManaNexusPrinceHEROIC"] = {
		...
		{ 7, 27831, "", "=q4=Mantle of the Unforgiven", "=ds=#s3#, #a1#", "", "9.20%"};
		{ 8, 27843, "", "=q4=Glyph-Lined Sash", "=ds=#s10#, #a1#", "", "10.80%"};
		{ 9, 27827, "", "=q4=Lucid Dream Bracers", "=ds=#s8#, #a2#"};
		{ 10, 27835, "", "=q4=Stillwater Girdle", "=ds=#s10#, #a3#", "", "6.06%"};
		{ 11, 27844, "", "=q4=Pauldrons of Swift Retribution", "=ds=#s3#, #a4#", "", "8.10%"};
		{ 12, 27798, "", "=q4=Gauntlets of Vindication", "=ds=#s9#, #a4#", "", "11.80%"};
		...
		{ 20, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 21, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};	
		{ 23, 27837, "", "=q4=Wastewalker Leggings", "=ds=#s11#, #a2# (D3)", "", "3.03%"};
		{ 24, 27828, "", "=q4=Warp-Scarab Brooch", "=ds=#s14#", "", "30.30%"};
		{ 25, 28400, "", "=q4=Warp-Storm Warblade", "=ds=#h1#, #w10#"};
		{ 26, 27829, "", "=q4=Axe of the Nexus-Kings", "=ds=#h2#, #w1#", "", "9.09%"};
		{ 27, 27840, "", "=q4=Scepter of Sha'tar", "=ds=#h2#, #w6#"};
		{ 28, 27842, "", "=q4=Grand Scepter of the Nexus-Kings", "=ds=#w9#", "", "9.09%"};
		{ 30, 92799, "", "=q3=Pandaren Air Spirit", "=ds=#e13#", "", ""};
		Prev = "AuchManaTavarok";
		Next = "AuchManaYor";
	};

	AtlasLoot_Data["AuchManaYor"] = {
		{ 1, 40753, "", "=q4=Emblem of Heroism", "=ds=#e15#", "", "100%"};
		...
		{ 9, 31554, "", "=q4=Windchanneller's Tunic", "=ds=#s5#, #a1#"};
		{ 10, 31562, "", "=q4=Skystalker's Tunic", "=ds=#s5#, #a2#"};
		{ 11, 31570, "", "=q4=Mistshroud Tunic", "=ds=#s5#, #a3#"};
		{ 12, 31578, "", "=q4=Slatesteel Breastplate", "=ds=#s5# #a4#"};
	...
	AtlasLoot_Data["AuchSethekkDarkweaver"] = {
		{ 1, 27919, "", "=q4=Light-Woven Slippers", "=ds=#s12#, #a1#", "", "13.90%"};
		{ 2, 27914, "", "=q4=Moonstrider Boots", "=ds=#s12#, #a2#", "", "12.26%"};
		{ 3, 27915, "", "=q4=Sky-Hunter Swift Boots", "=ds=#s12#, #a3#", "", "11.74%"};
		{ 4, 27918, "", "=q4=Bands of Syth", "=ds=#s8#, #a4#", "", "11.81%"};
		{ 5, 27917, "", "=q4=Libram of the Eternal Rest", "=ds=#s16#, #w16#", "", "14.12%"};
		{ 6, 27916, "", "=q4=Sethekk Feather-Darts", "=ds=#w11#", "", "11.34%"};
		{ 8, 24160, "", "=q4=Design: Khorium Inferno Band", "=ds=#p12# (355)", "", "0.29%"};
	...
	AtlasLoot_Data["AuchSethekkRavenGod"] = {
		...
		{ 7, 32769, "", "=q4=Belt of the Raven Lord", "=ds=#s10#, #a2#"};
		{ 8, 32778, "", "=q4=Boots of Righteous Fortitude", "=ds=#s12#, #a4#"};
		{ 9, 32779, "", "=q4=Band of Frigid Elements", "=ds=#s13#"};
		{ 10, 32781, "", "=q4=Talon of Anzu", "=ds=#h1#, #w4#"};
		{ 11, 32780, "", "=q4=The Boomstick", "=ds=#w5#"};
	...
	AtlasLoot_Data["AuchSethekkTalonKing"] = {
		...
		{ 4, 27776, "", "=q4=Shoulderpads of Assassination", "#s3#, #a2# (D3)", "", "10.21%"};
		{ 5, 27936, "", "=q4=Greaves of Desolation", "=ds=#s11#, #a3# (D3)", "", "12.00%"};
		{ 7, 27946, "", "=q4=Avian Cloak of Feathers", "=ds=#s4#", "", "10.21%"};
		{ 8, 27981, "", "=q4=Sethekk Oracle Cloak", "=ds=#s4#", "", "10.00%"};
		{ 9, 27985, "", "=q4=Deathforge Girdle", "=ds=#s10#, #a4#", "", "9.24%"};
		{ 10, 27925, "", "=q4=Ravenclaw Band", "=ds=#s13#", "", "12.79%"};
		{ 11, 27980, "", "=q4=Terokk's Nightmace", "=ds=#h1#, #w6#", "", "11.18%"};
		{ 12, 27986, "", "=q4=Crow Wing Reaper", "=ds=#h2#, #w1#", "", "8.50%"};
		...
		{ 24, 29249, "", "=q4=Bands of the Benevolent", "=ds=#s8#, #a1#", "", "4.49%"};
		{ 25, 29259, "", "=q4=Bracers of the Hunt", "=ds=#s8#, #a3#", "", "7.87%"};
		{ 26, 32073, "", "=q4=Spaulders of Dementia", "=ds=#s3#, #a4#"};
		{ 27, 29355, "", "=q4=Terokk's Shadowstaff", "=ds=#w9#", "", "0.16%"};
		{ 28, 33834, "", "=q1=The Headfeathers of Ikiss", "=ds=#m3#", "", "100%"};
		{ 30, 71387, "", "=q3=Brilliant Kaliri", "=ds=#e13#", "", ""};
	...
	AtlasLoot_Data["AuchShadowHellmaw"] = {
		{ 1, 27889, "", "=q4=Jaedenfire Gloves of Annihilation", "=ds=#s9#, #a1#", "", "13.58%"};
		{ 2, 27888, "", "=q4=Dream-Wing Helm", "=ds=#s1#, #a3#", "", "11.81%"};
		{ 3, 27884, "", "=q4=Ornate Boots of the Sanctified", "=ds=#s12#, #a4#", "", "13.15%"};
		{ 4, 27886, "", "=q4=Idol of the Emerald Queen", "=ds=#s16#, #w14#", "", "12.94%"};
		{ 5, 27887, "", "=q4=Platinum Shield of the Valorous", "=ds=#w8#", "", "10.88%"};
		{ 6, 27885, "", "=q4=Soul-Wand of the Aldor", "=ds=#w12#", "", "13.34%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40753, "", "=q4=Emblem of Heroism", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["AuchShadowBlackheart"] = {
		{ 1, 27468, "", "=q4=Moonglade Handwraps", "=ds=#s9#, #a2# (D3)", "", "6.67%"};
	...
	AtlasLoot_Data["AuchShadowGrandmaster"] = {
		{ 1, 27775, "", "=q4=Hallowed Pauldrons", "=ds=#s3#, #a1# (D3)", "", "16.11%"};
	...
	AtlasLoot_Data["AuchShadowMurmur"] = {
		...
		{ 3, 27902, "", "=q4=Silent Slippers of Meditation", "=ds=#s12#, #a1#", "", "12.28%"};
		{ 4, 27912, "", "=q4=Harness of the Deep Currents", "=ds=#s5#, #a3#", "", "13.59%"};
		{ 5, 27913, "", "=q4=Whispering Blade of Slaying", "=ds=#h1#, #w4#", "", "9.69%"};
		{ 6, 27905, "", "=q4=Greatsword of Horrid Dreams", "=ds=#h3#, #w10#", "", "9.35%"};
		{ 7, 27903, "", "=q4=Sonic Spear", "=ds=#w7#", "", "11.17%"};
		{ 8, 27910, "", "=q4=Silvermoon Crest Shield", "=ds=#w8#", "", "12.46%"};
		{ 10, 27778, "", "=q4=Spaulders of Oblivion", "=ds=#s3#, #a1# (D3)", "", "12.28%"};
		{ 11, 28232, "", "=q4=Robe of Oblivion", "=ds=#s5#, #a1# (D3)", "", "10.47%"};
		{ 12, 28230, "", "=q4=Hallowed Garments", "=ds=#s5#, #a1# (D3)", "", "11.46%"};
		{ 13, 27908, "", "=q4=Leggings of Assassination", "=ds=#s11#, #a2# (D3)", "", "8.76%"};
		{ 14, 27909, "", "=q4=Tidefury Kilt", "=ds=#s11#, #a3# (D3)", "", "13.87%"};
		{ 15, 27803, "", "=q4=Shoulderguards of the Bold", "=ds=#s3#, #a4# (D3)", "", "9.49%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40753, "", "=q4=Emblem of Valor", "=ds=#e15#", "", "100%"};
		{ 18, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 19, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		...
		{ 22, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 22, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 24, 30532, "", "=q4=Kirin Tor Master's Trousers", "=ds=#s11#, #a1#", "", "11.90%"};
		{ 25, 29357, "", "=q4=Master Thief's Gloves", "=ds=#s9#, #a2#"};
		{ 26, 29261, "", "=q4=Girdle of Ferocity", "=ds=#s10#, #a3#", "", "3.57%"};
		{ 27, 29353, "", "=q4=Shockwave Truncheon", "=ds=#h3#, #w6#", "", "10.71%"};
		{ 29, 63039, "", "=q4=Reins of the Drake of the West Wind", "=ds=#e12#", "", ""};
	...
	AtlasLoot_Data["CoTHillsbradDrake"] = {
		...
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 47241, "", "=q4=Badge of Triumph", "=ds=#e15#", "", "100%"};
		...
		{ 22, 28212, "", "=q4=Aran's Sorcerous Slacks", "=ds=#s11#, #a1#", "", "11.43%"};
		{ 23, 28214, "", "=q4=Grips of the Lunar Eclipse", "=ds=#s9#, #a2#", "", "2.86%"};
		{ 24, 28215, "", "=q4=Mok'Nathal Mask of Battle", "=ds=#s1#, #a3#", "", "11.43%"};
		{ 25, 28211, "", "=q4=Lieutenant's Signet of Lordaeron", "=ds=#s13#", "", "5.71%"};
		{ 26, 28213, "", "=q4=Lordaeron Medical Guide", "=ds=#s15#", "", "8.57%"};
		{ 27, 28210, "", "=q4=Bloodskull Destroyer", "=ds=#h1#, #w6#", "", "5.71%"};
	...
	AtlasLoot_Data["CoTHillsbradSkarloc"] = {
		...
		{ 19, 30591, "", "=q4=Empowered Fire Opal", "=ds=#e7#", "", "0.24%"};
		{ 20, 30590, "", "=q4=Enduring Chrysoprase", "=ds=#e7#", "", "0.10%"};
		{ 22, 28218, "", "=q4=Pontiff's Pantaloons of Prophecy", "=ds=#s11#, #a1#", "", "18.18%"};
		{ 23, 28220, "", "=q4=Moon-Crown Antlers", "=ds=#s1#, #a2#", "", "0.14%"};
		{ 24, 28219, "", "=q4=Emerald-Scale Greaves", "=ds=#s11#, #a3#", "", "3.03%"};
		{ 25, 28221, "", "=q4=Boots of the Watchful Heart", "=ds=#s12#, #a4#", "", "0.52%"};
		{ 26, 28217, "", "=q4=Tarren Mill Vitality Locket", "=ds=#s2#", "", "9.09%"};
		{ 27, 28216, "", "=q4=Dathrohan's Ceremonial Hammer", "=ds=#h3#, #w6#", "", "6.06%"};
	...
	AtlasLoot_Data["CoTHillsbradHunterHEROIC"] = {
		{ 1, 47241, "", "=q4=Badge of Triumph", "=ds=#e15#", "", "100%"};
		...
		{ 8, 27911, "", "=q4=Epoch's Whispering Cinch", "=ds=#s10#, #a2#", "", "10.00%"};
		{ 9, 28344, "", "=q4=Wyrmfury Pauldrons", "=ds=#s3#, #a3#", "", "0.24%"};
		{ 10, 28233, "", "=q4=Necklace of Resplendent Hope", "=ds=#s2#", "", "15.00%"};
		{ 11, 27904, "", "=q4=Resounding Ring of Glory", "=ds=#s13#", "", "0.17%"};
		{ 12, 28227, "", "=q4=Sparking Arcanite Ring", "=ds=#s13#", "", "0.24%"};
		{ 13, 28223, "", "=q4=Arcanist's Stone", "=ds=#s14#", "", "10.00%"};
		{ 14, 28226, "", "=q4=Timeslicer", "=ds=#h1#, #w4#", "", "5.00%"};
		{ 15, 28222, "", "=q4=Reaver of the Infinites", "=ds=#h2#, #w1#", "", "0.48%"};
		{ 16, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 17, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		{ 18, 52178, "", "=q4=Zephyrite", "=ds=#e7#", "", ""};
		{ 19, 52177, "", "=q4=Carnelian", "=ds=#e7#", "", ""};
		{ 20, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 21, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 23, 28191, "", "=q4=Mana-Etched Vestments", "=ds=#s5#, #a1# (D3)", "", "0.24%"};
		{ 24, 28224, "", "=q4=Wastewalker Helm", "=ds=#s1#, #a2# (D3)", "", "0.24%"};
		{ 25, 28401, "", "=q4=Hauberk of Desolation", "=ds=#s5#, #a3# (D3)", "", "0.14%"};
		{ 26, 28225, "", "=q4=Doomplate Warhelm", "=ds=#s1#, #a4# (D3)", "", "0.14%"};
		{ 28, 24173, "", "=q4=Design: Circlet of Arcane Might", "=ds=#p12# (370)", "", "0.10%"};
		{ 13, 86564, "", "=q3=Imbued Jade Fragment", "=ds=#e13#", "", ""};
		Prev = "CoTHillsbradSkarloc";
	};
	...
	AtlasLoot_Data["CoTMorassDeja"] = {
		{ 1, 27988, "", "=q4=Burnoose of Shifting Ages", "=ds=#s4#", "", "13.87%"};
		{ 2, 27994, "", "=q4=Mantle of Three Terrors", "=ds=#s3#, #a1#", "", "12.30%"};
		{ 3, 27995, "", "=q4=Sun-Gilded Shouldercaps", "=ds=#s3#, #a2#", "", "13.13%"};
		{ 4, 27993, "", "=q4=Mask of Inner Fire", "=ds=#s1#, #a3#", "", "13.84%"};
		{ 5, 27996, "", "=q4=Ring of Spiritual Precision", "=ds=#s13#", "", "14.45%"};
		{ 6, 27987, "", "=q4=Melmorta's Twilight Longbow", "=ds=#w2#", "", "11.51%"};
		{ 8, 29675, "", "=q2=Pattern: Arcane Armor Kit", "=ds=#p7# (340)", "", "0.35%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["CoTMorassTemporus"] = {
		{ 1, 28185, "", "=q4=Khadgar's Kilt of Abjuration", "=ds=#s11#, #a1#", "", "14.26%"};
		{ 2, 28186, "", "=q4=Laughing Skull Battle-Harness", "=ds=#s5#, #a3#", "", "13.14%"};
		{ 3, 28034, "", "=q4=Hourglass of the Unraveller", "=ds=#s14#", "", "13.69%"};
		{ 4, 28187, "", "=q4=Star-Heart Lamp", "=ds=#s15#", "", "11.83%"};
		{ 5, 28184, "", "=q4=Millennium Blade", "=ds=#h1#, #w10#", "", "11.74%"};
		{ 6, 28033, "", "=q4=Epoch-Mender", "=ds=#w9#", "", "13.80%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
		{ 18, 30558, "", "=q4=Glimmering Fire Opal", "=ds=#e7#"};
		{ 19, 30556, "", "=q4=Glinting Fire Opal", "=ds=#e7#"};
	...
	AtlasLoot_Data["CoTMorassAeonus"] = {
		{ 1, 28193, "", "=q4=Mana-Etched Crown", "=ds=#s1#, #a1# (D3)", "", "11.99%"};
		{ 2, 27509, "", "=q4=Handgrips of Assassination", "=ds=#s9#, #a2# (D3)", "", "12.84%"};
		{ 3, 27873, "", "=q4=Moonglade Pants", "=ds=#s11#, #a2# (D3)", "", "11.28%"};
		{ 4, 28192, "", "=q4=Helm of Desolation", "=ds=#s1#, #a3# (D3)", "", "12.77%"};
		{ 5, 27977, "", "=q4=Legplates of the Bold", "=ds=#s11#, #a4# (D3)", "", "9.92%"};
		{ 6, 27839, "", "=q4=Legplates of the Righteous", "=ds=#s11#, #a4# (D3)", "", "12.10%"};
		{ 8, 28206, "", "=q4=Cowl of the Guiltless", "=ds=#s1#, #a2#", "", "12.25%"};
		{ 9, 28194, "", "=q4=Primal Surge Bracers", "=ds=#s8#, #a3#", "", "13.51%"};
		{ 10, 28207, "", "=q4=Pauldrons of the Crimson Flight", "=ds=#s3#, #a4#", "", "11.11%"};
		{ 11, 28190, "", "=q4=Scarab of the Infinite Cycle", "=ds=#s14#", "", "11.32%"};
		{ 12, 28189, "", "=q4=Latro's Shifting Sword", "=ds=#h1#, #w10#", "", "9.70%"};
		{ 13, 28188, "", "=q4=Bloodfire Greatstaff", "=ds=#w9#", "", "10.48%"};
		{ 14, 30531, "", "=q4=Breeches of the Occultist", "=ds=#s11#, #a1#", "", "1.49%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
		{ 18, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 19, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		...
		{ 25, 29247, "", "=q4=Girdle of the Deathdealer", "=ds=#s10#, #a2#"};
		{ 26, 29253, "", "=q4=Girdle of Valorous Deeds", "=ds=#s10#, #a4#"};
		{ 27, 29356, "", "=q4=Quantum Blade", "=ds=#h2#, #w10#"};
		{ 28, 33858, "", "=q1=Aeonus's Hourglass", "=ds=#m3#", "", "100%"};
		{ 30, 68833, "", "=q3=Panther Cub", "=ds=#e13#", "", ""};
	...
	AtlasLoot_Data["MountHyjalWinterchill"] = {
		...
		{ 18, 49426, "", "=q4=Badge of Justice", "=ds=#e15#", "", ""};
	...
	AtlasLoot_Data["MountHyjalAnetheron"] = {
		...
		{ 22, 49426, "", "=q4=Badge of Justice", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["MountHyjalKazrogal"] = {
		...
		{ 18, 49426, "", "=q4=Emblem of Frost", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["MountHyjalAzgalor"] = {
		...
		{ 16, 49426, "", "=q4=Emblem of Frost", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["CFRSlaveMennu"] = {
		...
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		...
		{ 22, 27542, "", "=q4=Cord of Belief", "=ds=#s10#, #a1#", "", "16.50%"};
		{ 23, 27545, "", "=q4=Mennu's Scaled Leggings", "=ds=#s11#, #a2#", "", "8.50%"};
		{ 24, 27541, "", "=q4=Archery Belt of the Broken", "=ds=#s10#, #a3#", "", "12.75%"};
		{ 25, 27546, "", "=q4=Traitor's Noose", "=ds=#s2#", "", "13.75%"};
		{ 26, 27544, "", "=q4=Totem of Spontaneous Regrowth", "=ds=#s16#, #w15#", "", "12.25%"};
		{ 27, 27543, "", "=q4=Starlight Dagger", "=ds=#h3#, #w4#", "", "20.00%"};
	...
	AtlasLoot_Data["CFRSlaveRokmar"] = {
		...
		{ 19, 30605, "", "=q4=Vivid Chrysoprase", "=ds=#e7#", "", "9.39%"};
		{ 20, 30603, "", "=q4=Royal Tanzanite", "=ds=#e7#", "", "10.48%"};
		{ 22, 27550, "", "=q4=Ironscale War Cloak", "=ds=#s4#", "", "11.48%"};
		{ 23, 27547, "", "=q4=Coldwhisper Cord", "=ds=#s10#, #a1#", "", "14.85%"};
		{ 24, 28124, "", "=q4=Liar's Cord", "=ds=#s10#, #a2#", "", "8.96%"};
		{ 25, 27549, "", "=q4=Wavefury Boots", "=ds=#s12#, #a3#", "", "9.80%"};
		{ 26, 27548, "", "=q4=Girdle of Many Blessings", "=ds=#s10#, #a4#", "", "14.85%"};
		{ 27, 27551, "", "=q4=Skeletal Necklace of Battlerage", "=ds=#s2#", "", "16.25%"};
		Prev = "CFRSlaveMennu";
	...
	AtlasLoot_Data["CFRSlaveQuagmirran"] = {
		...
		{ 2, 27713, "", "=q4=Pauldrons of Desolation", "=ds=#s3#, #a3# (D3)", "", "10.70%"};
		{ 4, 27742, "", "=q4=Mage-Fury Girdle", "=ds=#s10#, #a1#", "", "12.00%"};
		{ 5, 27712, "", "=q4=Shackles of Quagmirran", "=ds=#s8#, #a2#"};
		{ 6, 27800, "", "=q4=Earthsoul Britches", "=ds=#s11#, #a2#", "", "13.76%"};
		{ 7, 28337, "", "=q4=Breastplate of Righteous Fury", "=ds=#s5#, #a4#", "", "8.73%"};
		{ 8, 27672, "", "=q4=Girdle of the Immovable", "=ds=#s10#, #a4#", "", "7.64%"};
		{ 9, 27740, "", "=q4=Band of Ursol", "=ds=#s13#", "", "12.23%"};
		{ 10, 27683, "", "=q4=Quagmirran's Eye", "=ds=#s14#", "", "7.86%"};
		{ 11, 27714, "", "=q4=Swamplight Lantern", "=ds=#s15#", "", "10.92%"};
		{ 12, 27673, "", "=q4=Phosphorescent Blade", "=ds=#h1#, #w10#"};
		{ 13, 27741, "", "=q4=Bleeding Hollow Warhammer", "=ds=#h3#, #w6#", "", "9.83%"};
		{ 15, 33821, "", "=q1=The Heart of Quagmirran", "=ds=#m3#", "", "100%"};
		{ 16, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		...
		{ 22, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 24, 29242, "", "=q4=Boots of Blasphemy", "=ds=#s12#, #a1#", "", "10.04%"};
		{ 25, 30538, "", "=q4=Midnight Legguards", "=ds=#s11#, #a2#", "", "8.95%"};
		{ 26, 32078, "", "=q4=Pauldrons of Wild Magic", "=ds=#s3#, #a3#"};
		{ 27, 29349, "", "=q4=Adamantine Chain of the Unbroken", "=ds=#s2#", "", "1.53%"};
		{ 29, 93039, "", "=q3=Viscidus Globule", "=ds=#e13#", "", ""};
		Prev = "CFRSlaveRokmar";
	};
	...
	AtlasLoot_Data["CFRSteamThespia"] = {
		{ 1, 27508, "", "=q4=Incanter's Gloves", "=ds=#s9#, #a1# (D3)", "", "17.09%"};
	...
	AtlasLoot_Data["CFRSteamSteamrigger"] = {
		{ 1, 27793, "", "=q4=Earth Mantle Handwraps", "=ds=#s9#, #a3#", "", "16.92%"};
		{ 2, 27790, "", "=q4=Mask of Pennance", "=ds=#s1#, #a4#", "", "16.65%"};
		{ 3, 27792, "", "=q4=Steam-Hinge Chain of Valor", "=ds=#s2#", "", "14.49%"};
		{ 4, 27791, "", "=q4=Serpentcrest Life-Staff", "=ds=#w9#", "", "17.09%"};
		{ 5, 27794, "", "=q4=Recoilless Rocket Ripper X-54", "=ds=#w5#", "", "15.88%"};
	...
	AtlasLoot_Data["CFRSteamWarlord"] = {
		...
		{ 3, 27738, "", "=q4=Incanter's Pauldrons", "=ds=#s3#, #a1# (D3)", "", "12.25%"};
		{ 4, 27737, "", "=q4=Moonglade Shoulders", "=ds=#s3#, #a2# (D3)", "", "12.89%"};
		{ 5, 27801, "", "=q4=Beast Lord Mantle", "=ds=#s3#, #a3# (D3)", "", "10.63%"};
		{ 6, 27510, "", "=q4=Tidefury Gauntlets", "=ds=#s9#, #a3# (D3)", "", "12.45%"};
		{ 7, 27874, "", "=q4=Beast Lord Leggings", "=ds=#s11#, #a3# (D3)", "", "9.56%"};
		{ 8, 28203, "", "=q4=Breastplate of the Righteous", "=ds=#s5#, #a4# (D3)", "", "10.98%"};
		{ 9, 27475, "", "=q4=Gauntlets of the Bold", "=ds=#s9#, #a4# (D3)", "", "10.05%"};
		{ 11, 27804, "", "=q4=Devilshark Cape", "=ds=#s4#", "", "12.18%"};
		{ 12, 27799, "", "=q4=Vermillion Robes of the Dominant", "=ds=#s5#, #a1#", "", "12.47%"};
		{ 13, 27795, "", "=q4=Sash of Serpentra", "=ds=#s10#, #a1#", "", "11.03%"};
		{ 14, 27806, "", "=q4=Fathomheart Gauntlets", "=ds=#s9#, #a3#", "", "14.84%"};
		{ 15, 27805, "", "=q4=Ring of the Silver Hand", "=ds=#s13#", "", "13.95%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		{ 18, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 19, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		{ 20, 52178, "", "=q4=Zephyrite", "=ds=#e7#", "", ""};
		{ 21, 52177, "", "=q4=Carnelian", "=ds=#e7#", "", ""};
		{ 22, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 23, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 25, 30543, "", "=q4=Pontifex Kilt", "=ds=#s11#, #a1#", "", "7.81%"};
		{ 26, 29243, "", "=q4=Wave-Fury Vambraces", "=ds=#s8#, #a3#", "", "17.97%"};
		{ 27, 29463, "", "=q4=Amber Bands of the Aggressor", "=ds=#s8#, #a4#", "", "2.34%"};
		{ 28, 29351, "", "=q4=Wrathtide Longbow", "=ds=#w2#", "", "3.52%"};
		{ 30, 90173, "", "=q3=Pandaren Water Spirit", "=ds=#e13#", "", ""};
	...
	AtlasLoot_Data["CFRUnderHungarfen"] = {
		...
		{ 22, 27746, "", "=q4=Arcanium Signet Bands", "=ds=#s8#, #a1#", "", "8.37%"};
		{ 23, 27745, "", "=q4=Hungarhide Gauntlets", "=ds=#s9#, #a3#", "", "13.79%"};
		{ 24, 27743, "", "=q4=Girdle of Living Flame", "=ds=#s10#, #a3#", "", "13.79%"};
		{ 25, 27748, "", "=q4=Cassock of the Loyal", "=ds=#s11#, #a4#", "", "7.39%"};
		{ 26, 27744, "", "=q4=Idol of Ursoc", "=ds=#s16#, #w14#", "", "16.26%"};
		{ 27, 27747, "", "=q4=Boggspine Knuckles", "=ds=#h4#, #w13#", "", "12.81%"};
		Next = "CFRUnderGhazan";
	};
	...
	AtlasLoot_Data["CFRUnderGhazan"] = {
		...
		{ 19, 30607, "", "=q4=Splendid Fire Opal", "=ds=#e7#", "", "6.50%"};
		{ 20, 30608, "", "=q4=Radiant Chrysoprase", "=ds=#e7#", "", "9.76%"};
		{ 22, 27760, "", "=q4=Dunewind Sash", "=ds=#s10#, #a2#", "", "14.67%"};
		{ 23, 27759, "", "=q4=Headdress of the Tides", "=ds=#s1#, #a3#", "", "13.33%"};
		{ 24, 27755, "", "=q4=Girdle of Gallantry", "=ds=#s10#, #a4#", "", "7.33%"};
		{ 25, 27758, "", "=q4=Hydra-fang Necklace", "=ds=#s2#", "", "12.00%"};
		{ 26, 27761, "", "=q4=Ring of the Shadow Deeps", "=ds=#s13#", "", "18.67%"};
		{ 27, 27757, "", "=q4=Greatstaff of the Leviathan", "=ds=#w9#", "", "16.00%"};
	...
	AtlasLoot_Data["CFRUnderSwamplord"] = {
		...
		{ 19, 30607, "", "=q4=Splendid Fire Opal", "=ds=#e7#", "", "6.50%"};
		{ 20, 30608, "", "=q4=Radiant Chrysoprase", "=ds=#e7#", "", "9.76%"};
		{ 22, 27764, "", "=q4=Hands of the Sun", "=ds=#s9#, #a1#", "", "12.14%"};
		{ 23, 27763, "", "=q4=Crown of the Forest Lord", "=ds=#s1#, #a2#", "", "20.00%"};
		{ 24, 27765, "", "=q4=Armwraps of Disdain", "=ds=#s8#, #a2#", "", "9.29%"};
		{ 25, 27766, "", "=q4=Swampstone Necklace", "=ds=#s2#", "", "17.14%"};
		{ 26, 27762, "", "=q4=Weathered Band of the Swamplord", "=ds=#s13#"};
		{ 27, 27767, "", "=q4=Bogreaver", "=ds=#h1#, #w1#", "", "9.29%"};
		Prev = "CFRUnderGhazan";
	...
	AtlasLoot_Data["CFRUnderStalkerHEROIC"] = {
		{ 1, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		...
		{ 7, 27781, "", "=q4=Demonfang Ritual Helm", "=ds=#s1#, #a1#", "", "8.94%"};
		{ 8, 27768, "", "=q4=Oracle Belt of Timeless Mystery", "=ds=#s10#, #a1#", "", "14.63%"};
		{ 9, 27938, "", "=q4=Savage Mask of the Lynx Lord", "=ds=#s1#, #a2#", "", "1.63%"};
		{ 10, 27773, "", "=q4=Barbaric Legstraps", "=ds=#s11#, #a3#", "", "9.35%"};
		{ 11, 27779, "", "=q4=Bone Chain Necklace", "=ds=#s2#", "", "14.23%"};
		{ 12, 27780, "", "=q4=Ring of Fabled Hope", "=ds=#s13#", "", "9.90%"};
		{ 13, 27896, "", "=q4=Alembic of Infernal Power", "=ds=#s14#", "", "12.60%"};
		{ 14, 27770, "", "=q4=Argussian Compass", "=ds=#s14#", "", "3.66%"};
		{ 16, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 17, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		{ 18, 52178, "", "=q4=Zephyrite", "=ds=#e7#", "", ""};
		{ 19, 52177, "", "=q4=Carnelian", "=ds=#e7#", "", ""};
		{ 20, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 21, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 23, 27907, "", "=q4=Mana-Etched Pantaloons", "=ds=#s11#, #a1# (D3)", "", "4.88%"};
		{ 24, 27771, "", "=q4=Doomplate Shoulderguards", "=ds=#s3#, #a4# (D3)", "", "6.50%"};
		{ 25, 27769, "", "=q4=Endbringer", "=ds=#h2#, #w10#", "", "9.35%"};
		{ 26, 27772, "", "=q4=Stormshield of Renewal", "=ds=#w8#", "", "13.01%"};
		{ 27, 24248, "", "=q1=Brain of the Black Stalker", "=ds=#m3#", "", "100%"};
		{ 28, 33826, "", "=q1=Black Stalker Egg", "=ds=#m3#", "", "100%"};
		{ 30, 69648, "", "=q3=Legs", "=ds=#e13#", "", ""};
		Prev = "CFRUnderSwamplord";
	};

		------------------------------------------------
		--- Coilfang Reservoir: Serpentshrine Cavern 10   ---
		------------------------------------------------
	...
	AtlasLoot_Data["CFRSerpentHydross"] = {
		...
		{ 23, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentLurker"] = {
		...
		{ 9, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentLeotheras"] = {
		...
		{ 20, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentHydross25Man"] = {
		...
		{ 10, 65070, "", "=q4=Bile-O-Tron Nut", "=ds=#s13#", "", "20%"};
		{ 11, 65082, "", "=q4=Lightning Conductor Band", "=ds=#s13#", "", "14%"};
		{ 16, 65072, "", "=q4=Heart of Rage", "=ds=#s14#", "", "18%"};
		{ 17, 65048, "", "=q4=Symbiotic Worm", "=ds=#s14#", "", "21%"};
		{ 19, 65133, "", "=q4=Book of Binding Will", "=ds=#s15#", "", "19%"};
		{ 20, 64673, "", "=q4=Relic of Eonar", "=ds=#s16#, #w14#", "", "11%"};
		{ 22, 47241, "", "=q4=Emblem of Triumph", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentLeotheras25Man"] = {
		...
		{ 20, 47241, "", "=q4=Emblem of Triumph", "=ds=#e15#", "", "100%"};
		{ 21, 49426, "", "=q4=Emblem of Frost", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["CFRSerpentKarathress25Man"] = {
		...
		{ 8, 65007, "", "=q4=Akirus the Worm-Breaker", "=ds=#h2#, #w6#", "", "15%"};
		...
		{ 20, 45624, "", "=q4=Emblem of Conquest", "=ds=#e15#", "", "100%"};
		{ 21, 47241, "", "=q4=Emblem of Triumph", "=ds=#e15#", "", "100%"};
		{ 23, 30323, "", "=q4=Plans: Boots of the Protector", "=ds=#p2# (375)", "", "15%"};
	...
	AtlasLoot_Data["GruulsLairHighKingMaulgarHEROIC"] = {
		...
		{ 20, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["GruulsLairHighKingMaulgar"] = {
		...
		{ 8, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		Next = "GruulGruul";
	};
	...
	AtlasLoot_Data["GruulGruulHEROIC"] = {
		...
		{ 11, 31750, "", "=q1=Earthen Signet", "=ds=#m3#", "", "100%"};
		{ 20, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
		{ 22, 81677, "", "=q4=Leggings of the Fallen Champion", "=ds=#h1#, #w10#", "", ""};
		{ 23, 82019, "", "=q4=Leggings of the Fallen Defender", "=ds=#h2#, #w1#", "", ""};
		{ 24, 90337, "", "=q4=Leggings of the Fallen Hero", "=ds=#w8#", "", ""};
		{ 25, 82218, "", "=q4=Leggings of the Fallen Hero", "=ds=#w11#", "", ""};
	...
	AtlasLoot_Data["HCRampWatchkeeper"] = {
		...
		{ 22, 27448, "", "=q4=Cloak of the Everliving", "=ds=#s4#", "", "28.37%"};
		{ 23, 27451, "", "=q4=Boots of the Darkwalker", "=ds=#s12#, #a1#", "", "16.61%"};
		{ 24, 27450, "", "=q4=Wild Stalker Boots", "=ds=#s12#, #a3#", "", "14.19%"};
		{ 25, 27447, "", "=q4=Bracers of Just Rewards", "=ds=#s8#, #a4#", "", "13.84%"};
		{ 26, 27449, "", "=q4=Blood Knight Defender", "=ds=#w8#", "", "13.15%"};
	...
	AtlasLoot_Data["HCRampOmor"] = {
		{ 1, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 2, 27465, "", "=q4=Mana-Etched Gloves", "=ds=#s9#, #a1#", "", "11.74%"};
		{ 3, 27466, "", "=q4=Headdress of Alacrity", "=ds=#s1#, #a1#", "", "12.10%"};
		{ 4, 27462, "", "=q4=Crimson Bracers of Gloom", "=ds=#s8#, #a1#", "", "7.12%"};
		{ 5, 27467, "", "=q4=Silent-Strider Kneeboots", "=ds=#s12#, #a2#", "", "16.37%"};
		{ 6, 27478, "", "=q4=Girdle of the Blasted Reaches", "=ds=#s10#, #a3#", "", "14.59%"};
		{ 7, 27539, "", "=q4=Justice Bearer's Pauldrons", "=ds=#s3#, #a4#", "", "8.90%"};
		{ 8, 27906, "", "=q4=Crimsonforge Breastplate", "#s5#, #a4#", "", "12.10%"};
		{ 9, 27464, "", "=q4=Omor's Unyielding Will", "=ds=#s2#", "", "13.52%"};
		{ 10, 27895, "", "=q4=Band of Many Prisms", "=ds=#s13#", "", "11.74%"};
		{ 11, 27477, "", "=q4=Faol's Signet of Cleansing", "=ds=#s15#", "", "10.32%"};
		{ 12, 27463, "", "=q4=Terror Flame Dagger", "=ds=#h1#, #w4#", "", "8.90%"};
		{ 13, 27476, "", "=q4=Truncheon of Five Hells", "=ds=#h1#, #w6#", "", "9.25%"};
		{ 16, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		{ 17, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 18, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		{ 19, 52178, "", "=q4=Zephyrite", "=ds=#e7#", "", ""};
		...
		{ 22, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 24, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 25, 24090, "", "=q3=Bloodstained Ravager Gauntlets", "=ds=#s9#, #a3#", "", "12.14%"};
		{ 26, 24091, "", "=q3=Tenacious Defender", "=ds=#s10#, #a4#", "", "12.67%"};
		{ 27, 24073, "", "=q3=Garotte-String Necklace", "=ds=#s2#", "", "11.60%"};
		{ 28, 24096, "", "=q3=Heartblood Prayer Beads", "=ds=#s2#", "", "11.15%"};
		{ 29, 24094, "", "=q3=Heart Fire Warhammer", "=ds=#h2#, #w6#", "", "14.76%"};
		{ 30, 24069, "", "=q3=Crystalfire Staff", "=ds=#w9#", "", "12.43%"};
	...
	AtlasLoot_Data["HCRampVazrudenHEROIC"] = {
		...
		{ 6, 27452, "", "=q4=Light Scribe Bands", "=ds=#s8#, #a1#", "", "11.73%"};
		{ 7, 27461, "", "=q4=Chestguard of the Prowler", "=ds=#s5#, #a2#", "", "11.73%"};
		{ 8, 27456, "", "=q4=Raiments of Nature's Breath", "=ds=#s5#, #a2#", "", "19.75%"};
		{ 9, 27454, "", "=q4=Volcanic Pauldrons", "=ds=#s3#, #a3#", "", "16.66%"};
		{ 10, 27458, "", "=q4=Oceansong Kilt", "=ds=#s11#, #a3#", "", "10.49%"};
		{ 11, 27455, "", "=q4=Irondrake Faceguard", "=ds=#s1#, #a4#", "", "11.11%"};
		{ 12, 27459, "", "=q4=Vambraces of Daring", "=ds=#s8#, #a4#", "", "10.49%"};
		{ 13, 27457, "", "=q4=Life Bearer's Gauntlets", "=ds=#s9#, #a4#", "", "8.02%"};
		{ 16, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		...
		{ 21, 27453, "", "=q4=Averinn's Ring of Slaying", "=ds=#s13#", "", "14.20%"};
		{ 22, 27460, "", "=q4=Reavers' Ring", "=ds=#s13#", "", "17.90%"};
		...
		{ 30, 71076, "", "=q3=Creepy Crate", "=ds=#e13#", "", ""};
		Prev = "HCRampOmor";
	};
	...
	AtlasLoot_Data["HCFurnaceMaker"] = {
		...
		{ 22, 27485, "", "=q4=Embroidered Cape of Mysteries", "=ds=#s4#", "", "13.89%"};
		{ 23, 27488, "", "=q4=Mage-Collar of the Firestorm", "=ds=#s1#, #a1#", "", "16.67%"};
		{ 24, 27483, "", "=q4=Moon-Touched Bands", "=ds=#s8#, #a2#", "", "25.00%"};
		{ 25, 27487, "", "=q4=Bloodlord Legplates", "=ds=#s11#, #a4#", "", "9.26%"};
		{ 26, 27484, "", "=q4=Libram of Avengement", "=ds=#s16#, #w16#", "", "14.81%"};
	...
	AtlasLoot_Data["HCFurnaceBroggok"] = {
		...
		{ 19, 30600, "", "=q4=Fluorescent Tanzanite", "=ds=#e7#", "", "9.85%"};
		{ 20, 30602, "", "=q4=Jagged Chrysoprase", "=ds=#e7#", "", "12.12%"};
		{ 22, 27848, "", "=q4=Embroidered Spellpyre Boots", "=ds=#s12#, #a1#", "", "8.33%"};
		{ 23, 27492, "", "=q4=Moonchild Leggings", "=ds=#s11#, #a2#", "", "13.89%"};
		{ 24, 27489, "", "=q4=Virtue Bearer's Vambraces", "=ds=#s8#, #a4#", "", "22.22%"};
		{ 25, 27491, "", "=q4=Signet of Repose", "=ds=#s13#", "", "30.56%"};
		{ 26, 27490, "", "=q4=Firebrand Battleaxe", "=ds=#h1#, #w1#", "", "9.72%"};
		Prev = "HCFurnaceMaker";
		Next = "HCFurnaceBreaker";
	};

	AtlasLoot_Data["HCFurnaceBreaker"] = {
		{ 1, 28264, "", "=q4=Wastewalker Tunic", "=ds=#s5#, #a2# (D3)", "", "6.82%"};
		{ 2, 27497, "", "=q4=Doomplate Gauntlets", "=ds=#s9#, #a4# (D3)", "", "9.09%"};
		{ 3, 27506, "", "=q4=Robe of Effervescent Light", "=ds=#s5#, #a1#", "", "17.42%"};
		{ 4, 27514, "", "=q4=Leggings of the Unrepentant", "=ds=#s11#, #a2#", "", "13.64%"};
		{ 5, 27522, "", "=q4=World's End Bracers", "=ds=#s8#, #a3#", "", "25.76%"};
		{ 6, 27494, "", "=q4=Emerald Eye Bracer", "=ds=#s8#, #a3#", "", "11.50%"};
		{ 7, 27505, "", "=q4=Ruby Helm of the Just", "=ds=#s1#, #a4#", "", "11.36%"};
		{ 8, 27788, "", "=q4=Bloodsworn Warboots", "=ds=#s12#, #a4#"};
		{ 9, 27495, "", "=q4=Soldier's Dog Tags", "=ds=#s2#", "", "9.85%"};
		{ 10, 28121, "", "=q4=Icon of Unyielding Courage", "=ds=#s14#", "", "8.33%"};
		{ 11, 27512, "", "=q4=The Willbreaker", "=ds=#h3#, #w10#", "", "6.06%"};
		{ 12, 27507, "", "=q4=Adamantine Repeater", "=ds=#w3#", "", "6.82%"};
		{ 13, 32080, "", "=q4=Mantle of Shadowy Embrace", "=ds=#s3#, #a2#"};
		{ 14, 29245, "", "=q4=Wave-Crest Striders", "=ds=#s12#, #a3#", "", "3.79%"};
		{ 15, 29239, "", "=q4=Eaglecrest Warboots", "=ds=#s12#, #a4#", "", "6.82%"};
		{ 16, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		{ 17, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 18, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		{ 19, 52178, "", "=q4=Zephyrite", "=ds=#e7#", "", ""};
		...
		{ 24, 91040, "", "=q3=Darkmoon Eye", "=ds=#e13#", "", ""};
		{ 25, 0, "INV_Box_01", "=q6=#j1#", ""};
		{ 26, 24397, "", "=q4=Raiments of Divine Authority", "=ds=#s5#, #a1#", "", "16.92%"};
		{ 27, 24395, "", "=q4=Mindfire Waistband", "=ds=#s10#, #a1#", "", "16.64%"};
		{ 28, 24398, "", "=q4=Mantle of the Dusk-Dweller", "=ds=#s3#, #a2#", "", "14.29%"};
		{ 29, 24396, "", "=q4=Vest of Vengeance", "=ds=#s5#, #a2#", "", "15.46%"};
		{ 30, 24394, "", "=q4=Warsong Howling Axe", "=ds=#h2#, #w1#", "", "15.52%"};
	...
	AtlasLoot_Data["HCHallsNethekurse"] = {
		...
		{ 3, 27519, "", "=q4=Cloak of Malice", "=ds=#s4#", "", "17.44%"};
		{ 4, 27517, "", "=q4=Bands of Nethekurse", "=ds=#s8#, #a1#", "", "17.52%"};
		{ 5, 27521, "", "=q4=Telaari Hunting Girdle", "=ds=#s10#, #a3#", "", "16.50%"};
		{ 6, 27520, "", "=q4=Greathelm of the Unbreakable", "=ds=#s1#, #a4#", "", "16.47%"};
		{ 7, 27518, "", "=q4=Ivory Idol of the Moongoddess", "=ds=#s16#, #w14#", "", "17.42%"};
	...
	AtlasLoot_Data["HCHallsPorung"] = {
		{ 1, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		...
		{ 6, 30709, "", "=q4=Pantaloons of Flaming Wrath", "=ds=#s11#, #a1#", "", "14.58%"};
		{ 7, 30707, "", "=q4=Nimble-foot Treads", "=ds=#s12#, #a2#", "", "10.42%"};
		{ 8, 30708, "", "=q4=Belt of Flowing Thought", "=ds=#s10#, #a3#", "", "12.50%"};
		{ 9, 30705, "", "=q4=Spaulders of Slaughter", "=ds=#s3#, #a4#", "", "21.88%"};
		{ 10, 30710, "", "=q4=Blood Guard's Necklace of Ferocity", "=ds=#s2#", "", "10.42%"};
	};

	AtlasLoot_Data["HCHallsOmrogg"] = {
		{ 1, 27802, "", "=q4=Tidefury Shoulderguards", "=ds=#s3#, #a3# (D3)", "", "17.02%"};
		{ 3, 27525, "", "=q4=Jeweled Boots of Sanctification", "=ds=#s12#, #a1#", "", "18.26%"};
	...
	AtlasLoot_Data["HCHallsKargath"] = {
		...
		{ 3, 27531, "", "=q4=Wastewalker Gloves", "=ds=#s9#, #a2# (D3)", "", "11.03%"};
		{ 4, 27474, "", "=q4=Beast Lord Handguards", "=ds=#s9#, #a3# (D3)", "", "10.73%"};
		{ 5, 27528, "", "=q4=Gauntlets of Desolation", "=ds=#s9#, #a3# (D3)", "", "13.86%"};
		{ 6, 27535, "", "=q4=Gauntlets of the Righteous", "=ds=#s9#, #a4# (D3)", "", "11.24%"};
		{ 8, 27527, "", "=q4=Greaves of the Shatterer", "=ds=#s11#, #a4#", "", "12.89%"};
		{ 9, 27529, "", "=q4=Figurine of the Colossus", "=ds=#s14#", "", "10.41%"};
		{ 10, 27534, "", "=q4=Hortus' Seal of Brilliance", "=ds=#s15#", "", "12.98%"};
		{ 11, 27533, "", "=q4=Demonblood Eviscerator", "=ds=#h3#, #w13#", "", "12.70%"};
		{ 12, 27538, "", "=q4=Lightsworn Hammer", "=ds=#h3#, #w6#", "", "10.6%"};
		{ 13, 27540, "", "=q4=Nexus Torch", "=ds=#w12#", "", "13.02%"};
		...
		{ 22, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 23, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 25, 29255, "", "=q4=Bands of Rarefied Magic", "=ds=#s8#, #a1#", "", "0.58%"};
		{ 26, 29263, "", "=q4=Forestheart Bracers", "=ds=#s8#, #a2#", "", "0.28%"};
		{ 27, 29254, "", "=q4=Boots of the Righteous Path", "=ds=#s12#, #a4#"};
		{ 28, 29348, "", "=q4=The Bladefist", "=ds=#h3#, #w13#", "", "3.39%"};
		{ 30, 71726, "", "=q3=Murky's Little Soulstone", "=ds=#e13#", "", ""};
		Prev = "HCHallsOmrogg";
	};
	...
	AtlasLoot_Data["HCMagtheridon"] = {
		...
		{ 6, 81030, "", "=q4=Girdle of the Endless Pit", "=ds=#s10#, #a4#"};
		{ 7, 80773, "", "=q4=Eye of Magtheridon", "=ds=#s14#"};
	...
	AtlasLoot_Data["KaraAttumenHEROIC"] = {
		...
		{ 21, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
...
AtlasLoot_Data["KaraAttumen"] = {
		...
		{ 21, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["KaraMoroes"] = {
		...
		{ 9, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		...
		{ 9, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["KaraOperaEvent"] = {
		...
		{ 2, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		...
		{ 11, 82397, "", "=q4=Wicked Witch's Hat", "=ds=#s1#, #a1#", "", ""};
		{ 12, 82089, "", "=q4=Ruby Slippers", "=ds=#s12#, #a1#", "", ""};
		{ 13, 82102, "", "=q4=Legacy", "=ds=#h2#, #w1#", "", ""};
		{ 14, 82066, "", "=q4=Blue Diamond Witchwand", "=ds=#w12#", "", ""};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["Romulo & Julianne"], "=q5="..AL["Romulo & Julianne"]};
		{ 17, 82088, "", "=q4=Masquerade Gown", "=ds=#s5#, #a1#", "", ""};
		{ 18, 80774, "", "=q4=Romulo's Poison Vial", "=ds=#s14#", "", ""};
		{ 19, 84259, "", "=q4=Blade of the Unrequited", "=ds=#h1#, #w4#", "", ""};
		{ 20, 84254, "", "=q4=Despair", "=ds=#h2#, #w10#", "", ""};
		{ 24, 0, "INV_Box_01", "=q6="..BabbleBoss["The Big Bad Wolf"], "=q5="..AL["Red Riding Hood"]};
		{ 25, 80784, "", "=q4=Red Riding Hood's Cloak", "=ds=#s4#", "", ""};
		{ 26, 85846, "", "=q4=Big Bad Wolf's Head", "=ds=#s1#, #a3#", "", ""};
		{ 27, 82054, "", "=q4=Big Bad Wolf's Paw", "=ds=#h3#, #w13#", "", ""};
		{ 28, 84256, "", "=q4=Wolfslayer Sniper Rifle", "=ds=#w5#", "", ""};
		Prev = "KaraMaiden";
		Next = "KaraCurator";
	};
		...
		{ 1, 0, "INV_Box_01", "=q6="..AL["Shared Drops"], ""};
		{ 2, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		{ 3, 28594, "", "=q4=Trial-FireTrousers", "=ds=#s11#, #a1#", "", "15.96%"};
		{ 4, 28591, "", "=q4=Earthsoul Leggings", "=ds=#s11#, #a2#", "", "12.45%"};
		{ 5, 28589, "", "=q4=Beastmaw Pauldrons", "=ds=#s3#, #a3#", "", "12.54%"};
		{ 6, 28593, "", "=q4=Eternium Greathelm", "=ds=#s1#, #a4#", "", "11.53%"};
	...
	AtlasLoot_Data["KaraCuratorHEROIC"] = {
		...
		{ 8, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["KaraNetherspite"] = {
		...
		{ 19, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		Prev = "KaraAran";
		Next = "KaraPrince";
	};
	...
	AtlasLoot_Data["KaraNightbane"] = {
		...
		{ 22, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
	};
	...
	AtlasLoot_Data["KaraNightbaneHEROIC"] = {
		...
		{ 22, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
	};
	...
	AtlasLoot_Data["KaraPrince"] = {
		...
		{ 15, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["SMTFireheart"] = {
		...
		{ 18, 71228, "", "=q4=Badge of Justice", "=ds=#s4#", "", ""};
	...
	AtlasLoot_Data["SMTVexallus"] = {
		...
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 72838, "", "=q4=Badge of Justice", "=ds=#s4#", "", ""};
		{ 19, 71010, "", "=q4=Orb of the Sin'dorei", "=ds=#s5#, #a2#", "", ""};
		{ 20, 70988, "", "=q4=Rod of the Blazing Light", "=ds=#s5#, #a4#", "", ""};
		{ 21, 70916, "", "=q4=Breastplate of Fierce Survival", "=ds=#s1#, #a4#", "", ""};
		{ 23, 71019, "", "=q4=Fel-tinged Mantle", "=ds=#s2#", "", ""};
		{ 24, 71323, "", "=q4=Edge of Oppression", "=ds=#h4#", "", ""};
		Prev = "SMTFireheart";
		Next = "SMTDelrissa";
	};
	...
	AtlasLoot_Data["SMTDelrissa"] = {
		...
		{ 16, 0, "INV_Box_01", "=q6=#j3#", ""};
		{ 17, 64645, "", "=q4=Badge of Justice", "=ds=#s14#", "", ""};
		...
		{ 21, 72880, "", "=q4=Vial of the Sunwell", "=ds=#s13#", "", ""};
		Prev = "SMTVexallus";
		Next = "SMTKaelthas";
	};
	...
	AtlasLoot_Data["SMTKaelthas"] = {
		...
		{ 10, 35504, "", "=q3=Phoenix Hatchling", "=ds=", "", ""};
		Prev = "SMTDelrissa";
	};

	AtlasLoot_Data["SMTKaelthasHEROIC"] = {
		{ 1, 71780, "", "=q4=Badge of Justice", "=ds=#h2#, #w10#", "", ""};
		{ 2, 72846, "", "=q4=Quickening Blade of the Prince", "=ds=#h2#, #w9#", "", ""};
		{ 3, 72833, "", "=q4=Cudgel of Consecration", "=ds=#h1#, #w6#", "", ""};
		{ 4, 71013, "", "=q4=Netherforce Chestplate", "=ds=#h1#, #w4#", "", ""};
		{ 5, 72878, "", "=q4=The Signet Ring of Prince Kael'thas", "=ds=#h4#", "", ""};
		{ 6, 67145, "", "=q4=Breeching Comet", "=ds=#w8#", "", ""};
		{ 7, 55788, "", "=q4=Breeching Comet", "=ds=#w8#", "", ""};
		{ 8, 90384, "", "=q4=Retribution", "=ds=#h1#, #w1#", "", ""};
		{ 9, 90381, "", "=q4=Kara", "=ds=#h1#, #w1#", "", ""};
		{ 10, 56108, "", "=q4=Blade of the Burning Sun", "=ds=#h1#, #w10#", "", ""};
		{ 11, 72810, "", "=q4=Windrunner's Bow", "=ds=#w2#", "", ""};
		{ 12, 56095, "", "=q4=Fel-tinged Mantle", "=ds=#s2#", "", ""};
		{ 16, 71265, "", "=q4=Scarlet Sin'dorei Robes", "=ds=#s8#, #a1#", "", ""};
		{ 17, 72825, "", "=q4=Shoulderpads of the Silvermoon Retainer", "=ds=#s3#, #a1#", "", ""};
		{ 18, 72882, "", "=q4=Tunic of the Ranger Lord", "=ds=#s5#, #a2#", "", ""};
		{ 19, 70913, "", "=q4=Greaves of the Penitent Knight", "=ds=#s11#, #a4#", "", ""};
		{ 21, 35513, "", "=q4=Swift White Hawkstrider", "=ds=", "", ""};
		{ 23, 35504, "", "=q3=Phoenix Hatchling", "=ds=", "", ""};
		Prev = "SMTDelrissa";
	};
	...
	AtlasLoot_Data["TKArcUnbound"] = {
		{ 1, 28373, "", "=q4=Cloak of Scintillating Auras", "=ds=#s4#", "", "17.13%"};
		{ 2, 28374, "", "=q4=Mana-Sphere Shoulderguards", "=ds=#s3#, #a1#", "", "20.35%"};
		{ 3, 28384, "", "=q4=Outland Striders", "=ds=#s12#, #a3#", "", "19.52%"};
		{ 4, 28375, "", "=q4=Rubium War-Girdle", "=ds=#s10#, #a4#", "", "14.38%"};
		{ 5, 28372, "", "=q4=Idol of Feral Shadows", "=ds=#s16#, #w14#", "", "15.80%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["TKArcScryer"] = {
		{ 1, 28396, "", "=q4=Gloves of the Unbound", "=ds=#s9#, #a2#", "", "17.80%"};
		{ 2, 28398, "", "=q4=The Sleeper's Cord", "=ds=#s10#, #a2#", "", "16.29%"};
		{ 3, 28394, "", "=q4=Ryngo's Band of Ingenuity", "=ds=#s13#", "", "16.81%"};
		{ 4, 28393, "", "=q4=Warmaul of Infused Light", "=ds=#h2#, #w6#", "", "16.14%"};
		{ 5, 28397, "", "=q4=Emberhawk Crossbow", "=ds=#w3#", "", "17.65%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		{ 18, 30582, "", "=q4=Deadly Fire Opal", "=ds=#e7#", "", "0.18%"};
		{ 19, 30575, "", "=q4=Nimble Fire Opal", "=ds=#e7#", "", "0.18%"};
	...
	AtlasLoot_Data["TKArcDalliah"] = {
		...
		{ 3, 28391, "", "=q4=Worldfire Chestguard", "=ds=#s5#, #a3#", "", "18.57%"};
		{ 4, 28390, "", "=q4=Thatia's Self-Correcting Gauntlets", "=ds=#s9#, #a4#", "", "14.80%"};
		{ 5, 28387, "", "=q4=Lamp of Peaceful Repose", "=ds=#s15#", "", "15.92%"};
		{ 6, 28392, "", "=q4=Reflex Blades", "=ds=#h3#, #w13#", "", "18.37%"};
		{ 7, 28386, "", "=q4=Nether Core's Control Rod", "#w12#", "", "15.29%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		{ 18, 30582, "", "=q4=Deadly Fire Opal", "=ds=#e7#", "", "0.18%"};
		{ 19, 30575, "", "=q4=Nimble Fire Opal", "=ds=#e7#", "", "0.18%"};
	...
	AtlasLoot_Data["TKArcHarbinger"] = {
		{ 1, 28415, "", "=q4=Hood of Oblivion", "=ds=#s1#, #a1# (D3)", "", "12.23%"};
		{ 2, 28413, "", "=q4=Hallowed Crown", "=ds=#s1#, #a1# (D3)", "", "12.17%"};
		{ 3, 28414, "", "=q4=Helm of Assassination", "=ds=#s1#, #a2# (D3)", "", "11.25%"};
		{ 4, 28231, "", "=q4=Tidefury Chestpiece", "=ds=#s5#, #a3# (D3)", "", "14.98%"};
		{ 5, 28403, "", "=q4=Doomplate Chestguard", "=ds=#s5#, #a4# (D3)", "", "13.15%"};
		{ 6, 28205, "", "=q4=Breastplate of the Bold", "=ds=#s5#, #a4# (D3)", "", "11.19%"};
		{ 8, 28406, "", "=q4=Sigil-Laced Boots", "=ds=#s12#, #a1#", "", "12.23%"};
		{ 9, 28419, "", "=q4=Choker of Fluid Thought", "=ds=#s2#", "", "14.92%"};
		{ 10, 28407, "", "=q4=Elementium Band of the Sentry", "=ds=#s13#", "", "10.70%"};
		{ 11, 28418, "", "=q4=Shiffar's Nexus-Horn", "=ds=#s14#", "", "12.23%"};
		{ 12, 28412, "", "=q4=Lamp of Peaceful Radiance", "=ds=#s15#", "", "13.15%"};
		{ 13, 28416, "", "=q4=Hungering Spineripper", "=ds=#h1#, #w4#", "", "12.35%"};
		{ 14, 29241, "", "=q4=Belt of Depravity", "=ds=#s10#, #a1#", "", "8.47%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40753, "", "=q4=Badge of Valor", "=ds=#e15#", "", "100%"};
		{ 18, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 19, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		...
		{ 22, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 23, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 25, 29248, "", "=q4=Shadowstep Striders", "=ds=#s12#, #a2#", "", "0.61%"};
		{ 26, 29252, "", "=q4=Bracers of Dignity", "=ds=#s8#, #a4#", "", "3.03%"};
		{ 27, 29360, "", "=q4=Vileblade of the Betrayer", "=ds=#h1#, #w4#", "", "0.18%"};
		{ 28, 33861, "", "=q1=The Scroll of Skyriss", "=ds=#m3#", "", "100%"};
		{ 30, 93041, "", "=q3=Jewel of Maddening Whispers", "=ds=#e13#", "", ""};
		Prev = "TKArcDalliah";
	};
	...
	AtlasLoot_Data["TKBotSarannis"] = {
		{ 1, 28301, "", "=q4=Syrannis' Mystic Sheen", "=ds=#s4#", "", "28.54%"};
		{ 2, 28304, "", "=q4=Prismatic Mittens of Mending", "=ds=#s9#, #a1#", "", "32.46%"};
		{ 3, 28306, "", "=q4=Towering Mantle of the Hunt", "=ds=#s3#, #a3#", "", "30.68%"};
		{ 4, 28296, "", "=q4=Libram of the Lightbringer", "=ds=#s16#, #w16#", "", "34.10%"};
		{ 5, 28311, "", "=q4=Revenger", "=ds=#h1#, #w10#", "", "26.25%"};
	...
	AtlasLoot_Data["TKBotFreywinn"] = {
		{ 1, 28317, "", "=q4=Energis Armwraps", "=ds=#s9#, #a1#", "", "17.60%"};
		{ 2, 28318, "", "=q4=Obsidian Clodstompers", "=ds=#s12#, #a4#", "", "16.48%"};
		{ 3, 28321, "", "=q4=Enchanted Thorium Torque", "=ds=#s2#", "", "18.09%"};
		{ 4, 28315, "", "=q4=Stormreaver Warblades", "=ds=#h4#, #w13#", "", "16.75%"};
		{ 5, 28316, "", "=q4=Aegis of the Sunbird", "=ds=#w8#", "", "14.60%"};
		{ 7, 23617, "", "=q4=Plans: Earthpeace Breastplate", "=ds=#p2# (370)", "", "1.07%"};
		{ 9, 31744, "", "=q1=Botanist's Field Guide", "=ds=#m3#", "", "100%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 29434, "", "=q4=Badge of Herois", "=ds=#e15#", "", "100%"};
		{ 18, 30574, "", "=q4=Brutal Tanzanite", "=ds=#e7#", "", "8.00%"};
		{ 19, 30572, "", "=q4=Imperial Tanzanite", "=ds=#e7#", "", "8.00%"};
		{ 20, 30573, "", "=q4=Mysterious Fire Opal", "=ds=#e7#", "", "8.00%"};
		Prev = "TKBotSarannis";
	...
	AtlasLoot_Data["TKBotThorngrin"] = {
		...
		{ 3, 28324, "", "=q4=Gauntlets of Cruel Intention", "=ds=#s9#, #a4#", "", "15.56%"};
		{ 4, 28327, "", "=q4=Arcane Netherband", "=ds=#s13#", "", "17.77%"};
		{ 5, 28323, "", "=q4=Ring of Umbral Doom", "=ds=#s13#", "", "16.25%"};
		{ 6, 28322, "", "=q4=Runed Dagger of Solace", "=ds=#h3#, #w4#", "", "18.16%"};
		{ 7, 28325, "", "=q4=Dreamer's Dragonstaff", "=ds=#w9#", "", "15.46%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		{ 18, 30574, "", "=q4=Brutal Tanzanite", "=ds=#e7#", "", "8.00%"};
		{ 19, 30572, "", "=q4=Imperial Tanzanite", "=ds=#e7#", "", "8.00%"};
	...
	AtlasLoot_Data["TKBotLaj"] = {
		{ 1, 27739, "", "=q4=Spaulders of the Righteous", "=ds=#s3#, #a4# (D3)", "", "18.13%"};
		{ 3, 28328, "", "=q4=Mithril-Bark Cloak", "=ds=#s4#", "", "20.88%"};
		{ 4, 28338, "", "=q4=Devil-Stitched Leggings", "=ds=#s11#, #a1#", "", "18.71%"};
		{ 5, 28340, "", "=q4=Mantle of Autumn", "=ds=#s3#, #a2#", "", "17.19%"};
		{ 6, 28339, "", "=q4=Boots of the Shifting Sands", "=ds=#s12#, #a2#", "", "19.07%"};
		{ 16, 0, "INV_Box_01", "=q6=#j27#", ""};
		{ 17, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		{ 18, 30574, "", "=q4=Brutal Tanzanite", "=ds=#e7#", "", "8.00%"};
		{ 19, 30572, "", "=q4=Imperial Tanzanite", "=ds=#e7#", "", "8.00%"};
	...
	AtlasLoot_Data["TKBotSplinter"] = {
		...
		{ 3, 28371, "", "=q4=Netherfury Cape", "=ds=#s4#", "", "13.52%"};
		{ 4, 28342, "", "=q4=Warp Infused Drape", "=ds=#s5#, #a1#", "", "10.27%"};
		{ 5, 28347, "", "=q4=Warpscale Leggings", "=ds=#s11#, #a2#", "", "11.74%"};
		{ 6, 28343, "", "=q4=Jagged Bark Pendant", "=ds=#s2#", "", "12.34%"};
		{ 7, 28370, "", "=q4=Bangle of Endless Blessings", "=ds=#s14#", "", "12.38%"};
		{ 8, 28345, "", "=q4=Warp Splinter's Thorn", "=ds=#h1#, #w4#", "", "10.37%"};
		{ 9, 28367, "", "=q4=Greatsword of Forlorn Visions", "=ds=#h2#, #w10#", "", "11.64%"};
		{ 10, 28341, "", "=q4=Warpstaff of Arcanum", "=ds=#w9#", "", "10.47%"};
		{ 12, 31085, "", "=q1=Top Shard of the Arcatraz Key", "=ds=#m3#", "", "100%"};
		{ 16, 28229, "", "=q4=Incanter's Robe", "=ds=#s5#, #a1# (D3)", "", "8.42%"};
		{ 17, 28348, "", "=q4=Moonglade Cowl", "=ds=#s1#, #a2# (D3)", "", "11.17%"};
		{ 18, 28349, "", "=q4=Tidefury Helm", "=ds=#s1#, #a3# (D3)", "", "13.85%"};
		{ 19, 28228, "", "=q4=Beast Lord Curiass", "=ds=#s5#, #a3# (D3)", "", "9.59%"};
		{ 20, 28350, "", "=q4=Warhelm of the Bold", "=ds=#s1#, #a4# (D3)", "", "8.96%"};
		Prev = "TKBotLaj";
	};
	...
	AtlasLoot_Data["TKBotSplinterHEROIC"] = {
		...
		{ 8, 28371, "", "=q4=Netherfury Cape", "=ds=#s4#", "", "4.00%"};
		{ 9, 28342, "", "=q4=Warp Infused Drape", "=ds=#s5#, #a1#", "", "8.00%"};
		{ 10, 28347, "", "=q4=Warpscale Leggings", "=ds=#s11#, #a2#", "", "12.00%"};
		{ 11, 28343, "", "=q4=Jagged Bark Pendant", "=ds=#s2#", "", "4.00%"};
		{ 12, 28370, "", "=q4=Bangle of Endless Blessings", "=ds=#s14#", "", "28.00%"};
		{ 13, 28345, "", "=q4=Warp Splinter's Thorn", "=ds=#h1#, #w4#", "", "28.00%"};
		{ 14, 28367, "", "=q4=Greatsword of Forlorn Visions", "=ds=#h2#, #w10#", "", "8.00%"};
		{ 15, 28341, "", "=q4=Warpstaff of Arcanum", "=ds=#w9#", "", "4.00%"};
		{ 16, 52179, "", "=q4=Alicite", "=ds=#e7#", "", ""};
		{ 17, 52181, "", "=q4=Hessonite", "=ds=#e7#", "", ""};
		{ 18, 52178, "", "=q4=Zephyrite", "=ds=#e7#", "", ""};
		{ 19, 52177, "", "=q4=Carnelian", "=ds=#e7#", "", ""};
		{ 20, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 21, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 23, 28229, "", "=q4=Incanter's Robe", "=ds=#s5#, #a1# (D3)", "", "4.00%"};
		{ 24, 28348, "", "=q4=Moonglade Cowl", "=ds=#s1#, #a2# (D3)", "", "12.00%"};
		{ 25, 28349, "", "=q4=Tidefury Helm", "=ds=#s1#, #a3# (D3)", "", "12.00%"};
		{ 26, 28228, "", "=q4=Beast Lord Curiass", "=ds=#s5#, #a3# (D3)", "", "20.00%"};
		{ 27, 28350, "", "=q4=Warhelm of the Bold", "=ds=#s1#, #a4# (D3)", "", "16.00%"};
		{ 28, 31085, "", "=q1=Top Shard of the Arcatraz Key", "=ds=#m3#", "", "100%"};
		{ 30, 46325, "", "=q3=Withers", "=ds=#e13#", "", ""};
		Prev = "TKBotLaj";
	};
	...
	AtlasLoot_Data["TKMechCacheoftheLegion"] = {
		...
		{ 2, 40752, "", "=q4=Badge of Heroism", "=ds=#e15#", "", "100%"};
		{ 3, 28249, "", "=q4=Capacitus' Cloak of Calibration", "=ds=#s4#", "", "21.16%"};
		{ 4, 28250, "", "=q4=Vestia's Pauldrons of Inner Grace", "=ds=#s3#, #a1#", "", "17.89%"};
		{ 5, 28252, "", "=q4=Bloodfyre Robes of Annihilation", "=ds=#s5#, #a1#", "", "22.53%"};
		{ 6, 28251, "", "=q4=Boots of the Glade-Keeper", "=ds=#s12#, #a2#", "", "18.74%"};
		{ 7, 28248, "", "=q4=Totem of the Void", "=ds=#s16#, #w15#", "", "19.58%"};
	...
	AtlasLoot_Data["TKMechCapacitus"] = {
		{ 1, 28256, "", "=q4=Thoriumweave Cloak", "=ds=#s4#", "", "14.81%"};
		{ 2, 28255, "", "=q4=Lunar-Claw Pauldrons", "=ds=#s3#, #a2#", "", "16.98%"};
		{ 3, 28254, "", "=q4=Warp Engineer's Prismatic Chain", "=ds=#s2#", "", "16.81%"};
		{ 4, 28257, "", "=q4=Hammer of the Penitent", "=ds=#h3#, #w6#", "", "14.36%"};
		{ 5, 28253, "", "=q4=Plasma Rat's Hyper-Scythe", "=ds=#w7#", "", "17.69%"};
	...
	AtlasLoot_Data["TKMechSepethrea"] = {
		{ 1, 28262, "", "=q4=Jade-Skull Breastplate", "=ds=#s5#, #a4#", "", "15.37%"};
		{ 2, 28259, "", "=q4=Cosmic Lifeband", "=ds=#s13#", "", "18.06%"};
		{ 3, 28260, "", "=q4=Manual of the Nethermancer", "=ds=#s15#", "", "15.61%"};
		{ 4, 28263, "", "=q4=Stellaris", "=ds=#h1#, #w1#", "", "15.58%"};
		{ 5, 28258, "", "=q4=Nethershrike", "=ds=#w11#", "", "15.88%"};
	...
	AtlasLoot_Data["TKMechCalc"] = {
		{ 1, 28269, "", "=q4=Baba's Cloak of Arcanistry", "=ds=#s4#", "", "11.78%"};
		{ 2, 28266, "", "=q4=Molten Earth Kilt", "=ds=#s11#, #a3#", "", "12.26%"};
		{ 3, 28265, "", "=q4=Dath'Remar's Ring of Defense", "=ds=#s13#", "", "10.61%"};
		{ 4, 28288, "", "=q4=Abacus of Violent Odds", "=ds=#s14#", "", "10.54%"};
		{ 5, 27899, "", "=q4=Mana Wrath", "=ds=#h3#, #w10#", "", "11.38%"};
		{ 6, 28267, "", "=q4=Edge of the Cosmos", "=ds=#h1#, #w10#", "", "11.13%"};
		{ 7, 28286, "", "=q4=Telescopic Sharprifle", "=ds=#w5#", "", "12.28%"};
		{ 9, 21907, "", "=q2=Pattern: Arcanoweave Robe", "=ds=#p8# (370)", "", "1.11%"};
		{ 11, 31086, "", "=q1=Bottom Shard of the Arcatraz Key", "=ds=#m3#", "", "100%"};
		{ 16, 28278, "", "=q4=Incanter's Cowl", "=ds=#s1#, #a1# (D3)", "", "13.39%"};
		{ 17, 28202, "", "=q4=Moonglade Robe", "=ds=#s5#, #a2# (D3)", "", "11.92%"};
		{ 18, 28204, "", "=q4=Tunic of Assassination", "=ds=#s5#, #a2# (D3)", "", "12.44%"};
		{ 19, 28275, "", "=q4=Beast Lord Helm", "=ds=#s1#, #a3# (D3)", "", "12.37%"};
		{ 20, 28285, "", "=q4=Helm of the Righteous", "=ds=#s1#, #a4# (D3)", "", "10.88%"};
	...
	AtlasLoot_Data["TKMechCalcHEROIC"] = {
		...
		{ 7, 28269, "", "=q4=Baba's Cloak of Arcanistry", "=ds=#s4#", "", "11.82%"};
		{ 8, 28266, "", "=q4=Molten Earth Kilt", "=ds=#s11#, #a3#", "", "14.29%"};
		{ 9, 28265, "", "=q4=Dath'Remar's Ring of Defense", "=ds=#s13#", "", "8.87%"};
		{ 10, 28288, "", "=q4=Abacus of Violent Odds", "=ds=#s14#", "", "8.37%"};
		{ 11, 27899, "", "=q4=Mana Wrath", "=ds=#h3#, #w10#", "", "9.36%"};
		{ 12, 28267, "", "=q4=Edge of the Cosmos", "=ds=#h1#, #w10#", "", "11.82%"};
		{ 13, 28286, "", "=q4=Telescopic Sharprifle", "=ds=#w5#", "", "9.85%"};
		...
		{ 20, 52182, "", "=q4=Jasper", "=ds=#e7#", "", ""};
		{ 21, 52180, "", "=q4=Nightstone", "=ds=#e7#", "", ""};
		{ 23, 28278, "", "=q4=Incanter's Cowl", "=ds=#s1#, #a1# (D3)", "", "14.29%"};
		{ 24, 28202, "", "=q4=Moonglade Robe", "=ds=#s5#, #a2# (D3)", "", "11.33%"};
		{ 25, 28204, "", "=q4=Tunic of Assassination", "=ds=#s5#, #a2# (D3)", "", "8.87%"};
		{ 26, 28275, "", "=q4=Beast Lord Helm", "=ds=#s1#, #a3# (D3)", "", "14.78%"};
		{ 27, 28285, "", "=q4=Helm of the Righteous", "=ds=#s1#, #a4# (D3)", "", "10.34%"};
		{ 28, 31086, "", "=q1=Bottom Shard of the Arcatraz Key", "=ds=#m3#", "", "100%"};
		{ 30, 94124, "", "=q3=Sunreaver Micro-Sentry", "=ds=#e13#", "", ""};
		Prev = "TKMechSepethrea";
	};

		-----------------------------
		--- Tempest Keep: The Eye 10 ---
		-----------------------------
	...
	AtlasLoot_Data["TKEyeAlar"] = {
		...
		{ 21, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["TKEyeSolarian"] = {
		...
		{ 22, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["TKEyeKaelthas"] = {
		...
		{ 14, 45624, "", "=q4=Badge of Conquest", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["TKEyeVoidReaver25Man"] = {
		{ 1, 65077, "", "=q4=Power Generator Hood", "=ds=#s1#, #a1#", "", "13%"};
		{ 2, 65057, "", "=q4=Belt of the Nightmare", "=ds=#s10#, #a2#", "", "13%"};
		{ 3, 65049, "", "=q4=Leggings of Lethal Force", "=ds=#s11#, #a3#", "", "14%"};
		{ 4, 65038, "", "=q4=Dragon Bone Warhelm", "=ds=#s1#, #a4#", "", "12%"};
		{ 5, 65143, "", "=q4=Bracers of Impossible Strength", "=ds=#s8#, #a4#", "", "13%"};
		{ 6, 65053, "", "=q4=Bell of Enraging Resonance", "=ds=#s14#", "", "13%"};
		{ 7, 58184, "", "=q4=Core of Ripeness", "=ds=#s14#", "", "12%"};
	...
	AtlasLoot_Data["TKEyeSolarian25Man"] = {
		{ 1, 65044, "", "=q4=Flame Pillar Leggings", "=ds=#s11#, #a1#", "", "19%"};
		{ 2, 65030, "", "=q4=Leggings of Consuming Flames", "=ds=#s11#, #a1#", "", "19%"};
		{ 3, 65050, "", "=q4=Parasitic Bands", "=ds=#s8#, #a2#", "", "23%"};
		{ 4, 65141, "", "=q4=Proto-Handler's Gauntlets", "=ds=#s9#, #a3#", "", "18%"};
		{ 5, 65033, "", "=q4=Treads of Flawless Creation", "=ds=#s12#, #a3#", "", "23%"};
		{ 6, 65022, "", "=q4=Belt of the Blackhand", "=ds=#s10#, #a4#", "", "21%"};
		{ 7, 65121, "", "=q4=Terrastra's Legguards", "=ds=#s11#, #a4#", "", "19%"};
		{ 8, 60229, "", "=q4=War-Torn Crushers", "=ds=#s12#, #a4#", "", "17%"};
		{ 16, 68712, "", "=q4=Impatience of Youth", "=ds=#s14#", "", "21%"};
		{ 17, 58183, "", "=q4=Soul Casket", "=ds=#s14#", "", "22%"};
		{ 18, 68600, "", "=q4=Uhn'agh Fash, the Darkest Betrayal", "=ds=#h1#, #w4#", "", "23%"};
		{ 19, 65102, "", "=q4=Chelley's Staff of Dark Mending", "=ds=#w9#", "", "21%"};
		{ 20, 69607, "", "=q4=Touch of Discord", "=ds=#w12#", "", "18%"};
		{ 22, 47241, "", "=q4=Emblem of Triumph", "=ds=#e15#", "", "100%"};
	...
	AtlasLoot_Data["TKEyeKaelthas25Man"] = {
		{ 1, 60232, "", "=q4=Shroud of Endless Grief", "=ds=#s4#", "", "14%"};
		{ 2, 65108, "", "=q4=Drape of the Twins", "=ds=#s4#", "", "12%"};
		{ 3, 71415, "", "=q4=Dreadfire Drape", "=ds=#s4#", "", "14%"};
		{ 5, 65039, "", "=q4=Aberration's Leggings", "=ds=#s11#, #a2#", "", "15%"};
		{ 6, 65129, "", "=q4=Membrane of C'Thun", "=ds=#s1#, #a2#", "", "15%"};
		{ 7, 59481, "", "=q4=Helm of the Nether Scion", "=ds=#s1#, #a3#", "", "14%"};
		{ 8, 65120, "", "=q4=Arion's Crown", "=ds=#s1#, #a3#", "", "13%"};
		{ 9, 65119, "", "=q4=Gravitational Pull", "=ds=#s9#, #a4#", "", "12%"};
		{ 10, 67136, "", "=q4=Gilnean Ring of Ruination", "=ds=#s13#", "", "14%"};
		{ 11, 65145, "", "=q4=Shalug'doom, the Axe of Unmaking", "=ds=#h2#, #w1#", "", "12%"};
		{ 13, 47241, "", "=q4=Emblem of Triumph", "=ds=#e15#", "", "100%"};
		{ 16, 67423, "", "=q4=Chest of the Forlorn Conqueror", "=ds=Tier 11 #e15#", "", "69%"};
		{ 17, 67424, "", "=q4=Chest of the Forlorn Protector", "=ds=Tier 11 #e15#", "", "68%"};
		{ 18, 67425, "", "=q4=Chest of the Forlorn Vanquisher", "=ds=Tier 11 #e15#", "", "66%"};
	...
	AtlasLoot_Data["T456DeathKnightDPS"] = {
		...
		{ 9, 81241, "", "=q4=Nordrassil Headpiece", "=ds="..BabbleBoss["Lady Vashj"].." ("..BabbleZone["Serpentshrine Cavern"]..")"};
		{ 10, 80867, "", "=q4=Nordrassil Wrath-Mantle", "=ds="..BabbleBoss["Void Reaver"].." ("..BabbleZone["The Eye"]..")"};
		{ 11, 80861, "", "=q4=Nordrassil Chestpiece", "=ds="..BabbleBoss["Kael'thas Sunstrider"].." ("..BabbleZone["The Eye"]..")"};
		{ 12, 80927, "", "=q4=Nordrassil Gauntlets", "=ds="..BabbleBoss["Leotheras the Blind"].." ("..BabbleZone["Serpentshrine Cavern"]..")"};
		{ 13, 82812, "", "=q4=Nordrassil Wrath-Kilt", "=ds="..BabbleBoss["Fathom-Lord Karathress"].." ("..BabbleZone["Serpentshrine Cavern"]..")"};

		Back = "T456SET";
	};

	AtlasLoot_Data["T456DeathKnightTank"] = {
		{ 1, 0, "Spell_Nature_InsectSwarm", "=q6=#t4s1_3#", "=ec1=#m21#"};
		...
		{ 8, 0, "Spell_Deathknight_DeathStrike", "=q6=#t5s1_3#", "=ec1=#m22#"};
		{ 9, 87612, "", "=q4=Nordrassil Headpiece", "=ds="..BabbleBoss["Lady Vashj"].." ("..BabbleZone["Serpentshrine Cavern"]..")"};
		{ 10, 87494, "", "=q4=Nordrassil Wrath-Mantle", "=ds="..BabbleBoss["Void Reaver"].." ("..BabbleZone["The Eye"]..")"};
		{ 11, 90600, "", "=q4=Nordrassil Chestpiece", "=ds="..BabbleBoss["Kael'thas Sunstrider"].." ("..BabbleZone["The Eye"]..")"};
		{ 12, 87601, "", "=q4=Nordrassil Gauntlets", "=ds="..BabbleBoss["Leotheras the Blind"].." ("..BabbleZone["Serpentshrine Cavern"]..")"};
		{ 13, 87589, "", "=q4=Nordrassil Wrath-Kilt", "=ds="..BabbleBoss["Fathom-Lord Karathress"].." ("..BabbleZone["Serpentshrine Cavern"]..")"};
