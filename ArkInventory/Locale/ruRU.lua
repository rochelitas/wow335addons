...
--	wow skill names - must match exactly what is in game
	...
	L["WOW_SKILL_ENGINEERING"] = "Механика"
...
--	wow zone names - must match exactly what is in game
	L["WOW_ZONE_WINTERGRASP"] = "Озеро Ледяных Оков"
...
--	location names
	...
	L["LOCATION_PET"] = "Питомец"
	L["LOCATION_MOUNT"] = "Верховые животные"
--	L["LOCATION_TOKEN"] = ""
