...
--	wow zone names - must match exactly what is in game
	L["WOW_ZONE_WINTERGRASP"] = "Tausendwintersee"


--	wow item types - must match exactly what is in game
	L["WOW_ITEM_TYPE_ARMOR"] = "Rüstung"
	...
	L["WOW_ITEM_TYPE_CONSUMABLE_FLASK"] = "Fläschchen"
	L["WOW_ITEM_TYPE_CONSUMABLE_FOOD_AND_DRINK"] = "Speis & Trank" -- was Essen & Trinken
	L["WOW_ITEM_TYPE_CONSUMABLE_POTION"] = "Trank"
	L["WOW_ITEM_TYPE_CONSUMABLE_SCROLL"] = "Rolle"
	L["WOW_ITEM_TYPE_CONTAINER"] = "Behälter"
	L["WOW_ITEM_TYPE_CONTAINER_BAG"] = "Behälter"
	...
	L["WOW_ITEM_TYPE_CONTAINER_HERB"] = "Kräutertasche"
	...
	L["WOW_ITEM_TYPE_QUIVER"] = "Köcher"
	L["WOW_ITEM_TYPE_QUIVER_ARROW"] = "Köcher"
