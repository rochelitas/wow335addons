-- 
-- Default Russian Localisation for MobInfo
--
-- created by Stephan Wilms 
-- modified by Gourytch


MI2_Locale = GetLocale()
print("MI2_Locale="..MI2_Locale)

if ( MI2_Locale == "ruRU") then

MI2_SpellSchools = { Arcane="ar", Fire="fi", Frost="fr", Shadow="sh", Holy="ho", Nature="na" }

MI_TXT_WELCOME          = "MobInfo приветствует вас!"
MI_DESCRIPTION			= "Добавляет информацию о мобах и во всплывающее окно и о здоровье и мане в окно цели"
...
MI_TXT_MOB_DB_SIZE		= "MobInfo размер БД:  "
