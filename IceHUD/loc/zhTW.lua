...
L["1 combo point: yellow, 5 combo points: red"] = "1連擊點數: 黃色, 5連擊點數: 紅色"
...
L["Adjusts the size of the aura icon for this bar"] = "調整此動作條的光環圖示大小" -- Needs review
...
L["Alpha in combat"] = "戰鬥中的透明度"
L["Alpha out of combat"] = "Alpha out of combat" -- Requires localization
L["Always display bar"] = "永遠顯示動作條" -- Needs review
...
L["Background alpha for bars OOC and target accuired (takes precedence over Not Full)"] = "Background alpha for bars OOC and target accuired (takes precedence over Not Full)" -- Requires localization
...
L["Bar Font Bold"] = "動作條粗體字" -- Needs review
L["Bar Font Size"] = "動作條字體大小"
L["Bar Height"] = "動作條高度"
L["Bar Proportion"] = "動作條比例"
L["Bar Settings"] = "動作條設置"
L["Bar Space"] = "Bar Space" -- Requires localization
L["Bar Texture"] = "動作條材質"
L["Bar Texture Override"] = "Bar Texture Override" -- Requires localization
L["Bar Width"] = "動作條寬度"
L["Bar alpha In Combat"] = "戰鬥中動作條透明度"
...
L["Buff or debuff?"] = "Buff 或 debuff?"
...
L["Buff/Debuff Settings"] = "Buff/Debuff 設置"
L["Buff/debuff icon size"] = "Buff/Debuff 圖示尺寸"
...
L["Change color"] = "改變顏色" -- Needs review
...
L["How many buffs/debuffs is shown on each row"] = "How many buffs/debuffs is shown on each row" -- Requires localization
...
L["Time between display updates in seconds"] = "Time between display updates in seconds" -- Requires localization
