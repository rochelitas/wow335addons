...
if AL then
	...
	AL["Boss1"] = "Литари";
	AL["Boss2"] = "Родамирус";
	AL["Boss3"] = "Вели-Анитро";
	AL["Boss4"] = "Старый Пень";
	AL["Boss5"] = "Маниса";
	AL["Boss6"] = "Волтрис";
	AL["Boss7"] = "Кассфорт";
	...
	AL["Emblem of Triumph Rewards"] = "Награды за эмблемы доблести";
	AL["Emblem of Frost Rewards"] = "Награды за эмблемы завоевания";
    ...
    AL["PvP Old"] = "PvP 60 и 70 уровней";
	...
	AL["Weapons a8"] = "Оружия а8";
	AL["Weapons a7"] = "Оружия а7";
	...
	AL["Vengeful Gladiator\'s Weapons"] = "Оружие бессмертного гладиатора";
	AL["Cataclysmic Gladiator\'s Weapons"] = "Оружие гладиатора Катаклизма";
