...
---- Jewelcrafting
	...
	AtlasLoot_Data["EnchantingOstrov2"] = {
		...
		{ 6, "s250044", "250535", "=q1=Формула чар для оружия - мангуст II", "=ds=#sr# 450"};
		{ 7, "s250045", "250536", "=q1=Формула чар для оружия - ловкость IV", "=ds=#sr# 450"};
		{ 8, "s250046", "250537", "=q1=Формула чар для оружия - дух III", "=ds=#sr# 450"};
		{ 9, "s250047", "250538", "=q1=Формула чар для оружия - могущество IV", "=ds=#sr# 450"};
		{ 10, "s250048", "250539", "=q1=Формула чар для оружия - сила заклинаний IV", "=ds=#sr# 450"};		
		{ 11, "s250049", "250540", "=q1=Формула чар для оружия - берсерк II", "=ds=#sr# 450"};
		{ 12, "s250050", "250541", "=q1=Формула чар для оружия - меткость II", "=ds=#sr# 450"};
		{ 13, "s250053", "250542", "=q1=Формула чар для двуручного оружия - резня II", "=ds=#sr# 450"};
		{ 14, "s250054", "250543", "=q1=Формула чар для посоха - сила заклинаний III", "=ds=#sr# 450"};
		{ 15, "s250056", "250544", "=q1=Формула чар для оружия - черная магия II", "=ds=#sr# 450"};
	...
	AtlasLoot_Data["JewelOstrov"] = {
		{ 1, "s260000", "260500", "=q4=неустанный мглистый алмаз", "=ds=#sr# 450"};
		{ 2, "s260001", "260501", "=q4=Незыблемый мглистый алмаз", "=ds=#sr# 450"};
		{ 3, "s260002", "260502", "=q4=Строгий мглистый алмаз", "=ds=#sr# 450"};
		{ 4, "s260003", "260503", "=q4=Бездушный мглистый алмаз", "=ds=#sr# 450"};
		{ 5, "s260004", "260504", "=q4=Жалкий мглистый алмаз", "=ds=#sr# 450"};
		{ 6, "s260005", "260505", "=q4=Лучезарный мглистый алмаз", "=ds=#sr# 450"};
		{ 7, "s260006", "260506", "=q4=Оживляющий мглистый алмаз", "=ds=#sr# 450"};
		{ 8, "s260007", "260507", "=q4=Стремительный мглистый алмаз", "=ds=#sr# 450"};
		{ 9, "s260008", "260508", "=q4=Загадочный мглистый алмаз", "=ds=#sr# 450"};
		{ 10, "s260009", "260509", "=q4=Угасающий мглистый алмаз", "=ds=#sr# 450"};
		{ 11, "s260010", "260510", "=q4=Разрушительный мглистый алмаз", "=ds=#sr# 450"};
		{ 12, "s260011", "260511", "=q4=Хаотический мглистый алмаз", "=ds=#sr# 450"};
		{ 13, "s260012", "260512", "=q4=Заостренный мглистый алмаз", "=ds=#sr# 450"};
		{ 14, "s260013", "260513", "=q4=Живительный мглистый алмаз", "=ds=#sr# 450"};
		{ 15, "s260014", "260514", "=q4=Лучащийся мглистый алмаз", "=ds=#sr# 450"};
		{ 16, "s260015", "260515", "=q4=Нерушимый мглистый алмаз", "=ds=#sr# 450"};
		{ 17, "s260016", "260516", "=q4=Вечный мглистый алмаз", "=ds=#sr# 450"};
		{ 18, "s260017", "260517", "=q4=Могущественный мглистый алмаз", "=ds=#sr# 450"};
		{ 19, "s260018", "260518", "=q4=Жестокий мглистый алмаз", "=ds=#sr# 450"};
		{ 20, "s260019", "260519", "=q4=Громовой мглистый алмаз", "=ds=#sr# 450"};
		{ 21, "s260020", "260520", "=q4=Провидческий мглистый алмаз", "=ds=#sr# 450"};
		Back = "JEWELCRAFTINGMENU";
	};
