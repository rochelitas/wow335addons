...
--	wow zone names - must match exactly what is in game
	L["WOW_ZONE_WINTERGRASP"] = "겨울손아귀 호수"
...
--	wow item types - must match exactly what is in game
	...
	L["WOW_ITEM_TYPE_CONTAINER_SOULSHARD"] = "영혼의 가방"
	L["WOW_ITEM_TYPE_GEM"] = "보석"
	L["WOW_ITEM_TYPE_GLYPH"] = "문양"
	...
	L["WOW_ITEM_TYPE_TRADE_GOODS_ENCHANTMENT_ARMOR"] = "방어구 마부"
	L["WOW_ITEM_TYPE_TRADE_GOODS_ENCHANTMENT_WEAPON"] = "무기 마부"
